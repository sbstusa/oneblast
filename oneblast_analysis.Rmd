...
opts_chunk$set(tidy=TRUE,echo=TRUE,results='markup',strip.white=TRUE,cache=FALSE,highlight=TRUE,width.cutoff=132,size='footnotesize',out.width='1.2\\textwidth',message=FALSE,warning=TRUE,comment=NA, fig.path="oneblast_analysis_files/figure-html")
...
```{r fig1, cache=FALSE, tidy=FALSE, echo=FALSE, results=TRUE,fig.width=4,fig.height=4}
