...
opts_chunk$set(tidy=TRUE,echo=TRUE,results='markup',strip.white=TRUE,cache=TRUE,highlight=TRUE,width.cutoff=132,size='footnotesize',out.width='1.2\\textwidth',message=FALSE,warning=TRUE,comment=NA)
...
```{r fig1, tidy=FALSE, echo=FALSE, results=TRUE,fig.width=4,fig.height=4}
...
```{r tukeyHSD, warning=FALSE, message=FALSE}
