...
```{r init,echo=F}
library(knitr)
opts_chunk$set(eval=T,echo=F,results="hemailhashe",message=F,warning=F,cache=T)
...
# Create DV
data$subscribe01<-ifelse(data$emailhash%in%subscribers$emailhash,1,0)
