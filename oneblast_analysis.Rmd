...
## First subtract the proportion in each batch from the batch indicator.
prop_b<-unsplit(with(wrkdat, table(batchday2)/sum(table(batchday2))  ),wrkdat$batchday2)
B <- model.matrix(~-1+batchday2F,data=wrkdat)
Bmd <- B - prop_b ## subtraction is columnwise
